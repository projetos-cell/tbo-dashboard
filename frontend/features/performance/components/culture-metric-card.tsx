...
import { CULTURE_METRIC_MAP } from "@/features/performance/utils/performance-constants";
...
export function CultureMetricCard({
  metricId,
  normalizedScore,
  rawValue,
  available,
}: CultureMetricCardProps) {
  const def = CULTURE_METRIC_MAP.get(metricId);
  if (!def) return null;
