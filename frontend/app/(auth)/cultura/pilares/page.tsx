...
import { IconPlus, IconColumns3, IconGripVertical, IconSearch, IconX } from "@tabler/icons-react";
...
export default function PilaresPage() {
  ...
  const reorder = useReorderCulturaItems("pilar");
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Os pilares fundamentais da cultura organizacional.</p>
        </div>
        {canEdit && (
